...
subroutine popMetadat(err,message)
  ...
  deriv_meta(iLookDERIV%mLayerdPsi_dTheta)             = var_info('mLayerdPsi_dTheta'            , 'derivative in matric potential w.r.t. liquid water content'           , 'm'              , get_ixVarType('midSoil'), iMissVec, iMissVec, .false.)
